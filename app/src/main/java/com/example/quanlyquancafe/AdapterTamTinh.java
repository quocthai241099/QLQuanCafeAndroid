...
public class AdapterTamTinh extends ArrayAdapter<ChiTietDatMon> {
    ArrayList<ChiTietDatMon> lstChiTiet;
    Context context;
    int layoutID;
    public AdapterTamTinh(Context context, int resource, ArrayList<ChiTietDatMon> lstChiTiet)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        tenmon=convertView.findViewById(R.id.tvTenMonTamTinh);
        soluong=convertView.findViewById(R.id.tvSoLuongTamTinh);
        thanhtien=convertView.findViewById(R.id.tvThanhTienTamTinh);
